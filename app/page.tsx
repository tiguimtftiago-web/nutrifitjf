...
const traditional: Product[] = [
  ...
  "/images/WhatsApp%20Image%202026-09-24%20at%2022.03.02%20(1).jpeg?v=2",
  "/images/WhatsApp%20Image%202026-09-24%20at%2022.03.02%20(2).jpeg?v=2",
  "/images/WhatsApp%20Image%202026-09-24%20at%2022.03.02.jpeg?v=2",
  "/images/WhatsApp%20Image%202026-09-24%20at%2022.03.03.jpeg?v=2"
][i]}));
...
function ComboBuilder() {
  ...
  // Compatibilidade de toque: no Safari/iPhone usamos touchstart como caminho principal
  // e mantemos click apenas como fallback. O bloqueio temporal evita ação duplicada.
  ...
  const runClickAction = (action: () => void) => {
    if (Date.now() - lastTouchAction.current < 700) return;
    action();
  };
